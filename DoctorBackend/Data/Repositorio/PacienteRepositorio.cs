...
{
    internal class PacienteRepositorio : Repositorio<Paciente>, IPacienteRepositorio
    {
        ...
        public void Actualizar(Paciente paciente)
        {
            ...
            if (pacienteDb != null) 
            {
                ...
                pacienteDb.FechaActualizacion = paciente.FechaActualizacion;
                pacienteDb.FechaCreacion = paciente.FechaCreacion;
